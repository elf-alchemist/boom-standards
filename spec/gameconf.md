...
- `vanilla` - Equivalent to the DOS releases of The Ultimate Doom, Doom II, and Final Doom.
- `boom` - The Boom feature set as originally released in 1998.
- `mbf` - The MBF 2.03 feature set as released in 1999.
- `mbf21` - The feature set as described in the MBF21 specification in 2021.
- `id24` - The feature set as described in the ID24 specification.
